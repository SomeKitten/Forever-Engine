...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		/*
			var loadButton:FlxButton = new FlxButton(110, 38, "Load", function()
			{
				loadLevel();
		});*/
		...
		var curStageDropDown = new FlxUIDropDownMenu(10, 125, FlxUIDropDownMenu.makeStrIdLabelArray(stages, true), function(stage:String)
		{
			_song.stage = stages[Std.parseInt(stage)];
		});
		curStageDropDown.selectedLabel = _song.stage;
