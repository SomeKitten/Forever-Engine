...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("FunkinForever", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("FunkinForever", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "FunkinForever";
		app.meta["name"] = "Friday Night Funkin' Forever Engine";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: false,
			title: "Friday Night Funkin' Forever Engine",
			width: 1280,
			x: null,
			y: null,
		};
