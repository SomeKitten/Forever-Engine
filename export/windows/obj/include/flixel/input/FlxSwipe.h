...
class HXCPP_CLASS_ATTRIBUTES FlxSwipe_obj : public ::hx::Object
{
	...
	public:
		...
		void __construct(int ID, ::flixel::math::FlxPoint StartPosition, ::flixel::math::FlxPoint EndPosition,int StartTimeInTicks);
		...
		static ::hx::ObjectPtr< FlxSwipe_obj > __new(int ID, ::flixel::math::FlxPoint StartPosition, ::flixel::math::FlxPoint EndPosition,int StartTimeInTicks);
		static ::hx::ObjectPtr< FlxSwipe_obj > __alloc(::hx::Ctx *_hx_ctx,int ID, ::flixel::math::FlxPoint StartPosition, ::flixel::math::FlxPoint EndPosition,int StartTimeInTicks);
