...
HX_LOCAL_STACK_FRAME(_hx_pos_951af697d279505e_312_invalidChar,"haxe.format.JsonParser","invalidChar",0xa9f373d5,"haxe.format.JsonParser.invalidChar","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",312,0x53425a8f)
HX_LOCAL_STACK_FRAME(_hx_pos_951af697d279505e_318_invalidNumber,"haxe.format.JsonParser","invalidNumber",0x8e9d1988,"haxe.format.JsonParser.invalidNumber","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",318,0x53425a8f)
namespace haxe{
namespace format{
...
void JsonParser_obj::invalidChar(){
            	HX_STACKFRAME(&_hx_pos_951af697d279505e_312_invalidChar)
HXLINE( 313)		this->pos--;
...
void JsonParser_obj::invalidNumber(int start){
            	HX_STACKFRAME(&_hx_pos_951af697d279505e_318_invalidNumber)
