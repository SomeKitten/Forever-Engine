...
HXLINE( 212)			switch((int)(c)){
            				case (int)8: {
HXLINE( 224)					 ::StringBuf _this = this->buf;
HXDLIN( 224)					if (::hx::IsNotNull( _this->charBuf )) {
HXLINE( 224)						_this->flush();
            					}
HXDLIN( 224)					if (::hx::IsNull( _this->b )) {
HXLINE( 224)						_this->b = ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_12,1);
            					}
            					else {
HXLINE( 224)						_this->b->push(HX_("\\b",86,50,00,00));
            					}
            				}
            				break;
            				case (int)9: {
HXLINE( 222)					 ::StringBuf _this = this->buf;
HXDLIN( 222)					if (::hx::IsNotNull( _this->charBuf )) {
HXLINE( 222)						_this->flush();
            					}
HXDLIN( 222)					if (::hx::IsNull( _this->b )) {
HXLINE( 222)						_this->b = ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_13,1);
            					}
            					else {
HXLINE( 222)						_this->b->push(HX_("\\t",98,50,00,00));
            					}
            				}
            				break;
            				case (int)10: {
...
HXLINE( 218)						_this->b = ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_14,1);
            					}
            					else {
HXLINE( 218)						_this->b->push(HX_("\\n",92,50,00,00));
            					}
            				}
            				break;
            				case (int)12: {
HXLINE( 226)					 ::StringBuf _this = this->buf;
HXDLIN( 226)					if (::hx::IsNotNull( _this->charBuf )) {
HXLINE( 226)						_this->flush();
            					}
HXDLIN( 226)					if (::hx::IsNull( _this->b )) {
HXLINE( 226)						_this->b = ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_15,1);
            					}
            					else {
HXLINE( 226)						_this->b->push(HX_("\\f",8a,50,00,00));
            					}
            				}
            				break;
            				case (int)13: {
HXLINE( 220)					 ::StringBuf _this = this->buf;
HXDLIN( 220)					if (::hx::IsNotNull( _this->charBuf )) {
HXLINE( 220)						_this->flush();
            					}
HXDLIN( 220)					if (::hx::IsNull( _this->b )) {
HXLINE( 220)						_this->b = ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_16,1);
            					}
            					else {
HXLINE( 220)						_this->b->push(HX_("\\r",96,50,00,00));
            					}
            				}
            				break;
            				case (int)34: {
...
HXLINE( 214)						_this->b = ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_17,1);
            					}
            					else {
HXLINE( 214)						_this->b->push(HX_("\\\"",46,50,00,00));
            					}
            				}
            				break;
            				case (int)92: {
...
HXLINE( 216)						_this->b = ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_18,1);
            					}
            					else {
HXLINE( 216)						_this->b->push(HX_("\\\\",80,50,00,00));
            					}
            				}
            				break;
            				default:{
...
HXLINE( 249)							_this->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x));
            						}
            						else {
HXLINE( 249)							::Array< ::String > _this1 = _this->b;
HXDLIN( 249)							_this1->push(::Std_obj::string(x));
            						}
            					}
            					else {
HXLINE( 249)						if (::hx::IsNull( _this->charBuf )) {
HXLINE( 249)							_this->charBuf = ::Array_obj< char >::__new();
            						}
HXDLIN( 249)						_this->charBuf->push(c);
            					}
            				}
            			}
            		}
            		_hx_goto_10:;
HXLINE( 257)		{
HXLINE( 257)			 ::StringBuf _this1 = this->buf;
HXDLIN( 257)			{
HXLINE( 257)				if (::hx::IsNull( _this1->charBuf )) {
HXLINE( 257)					_this1->charBuf = ::Array_obj< char >::__new();
            				}
HXDLIN( 257)				_this1->charBuf->push(34);
            			}
            		}
            	}
